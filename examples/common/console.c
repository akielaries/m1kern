...
void console_init(void) {
  ...
  init.UART_BaudRate         = CONSOLE_BAUDRATE;
  init.UART_Mode.UARTMode_Tx = ENABLE;
  init.UART_Mode.UARTMode_Rx = ENABLE;
  init.UART_Int.UARTInt_Tx   = DISABLE;
  init.UART_Int.UARTInt_Rx   = DISABLE;
  init.UART_Ovr.UARTOvr_Tx   = DISABLE;
  init.UART_Ovr.UARTOvr_Rx   = DISABLE;
  init.UART_Hstm             = DISABLE;

  UART_Init(CONSOLE_UART, &init);
}
